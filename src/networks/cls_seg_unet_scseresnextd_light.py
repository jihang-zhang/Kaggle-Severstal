...
from backbone.scse_senet_mish import *
...
class SCSEResNeXtDUnet(nn.Module):
    ...
    def __init__(self,
        ...
        super(SCSEResNeXtDUnet, self).__init__()
        self.EX = 4
        ...
        feature_net = scse_resnext50d_32x4d(pretrained=imagenet_pretrained, num_classes=1000, in_chans=3)
