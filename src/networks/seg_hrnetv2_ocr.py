...
class HighResolutionNet(nn.Module):
    ...
    def __init__(self, config, num_classes, ocr_activation, **kwargs):
        ...
        self.conv_region = nn.Conv2d(last_inp_channels, num_classes, kernel_size=1)
        self.conv_context = nn.Conv2d(last_inp_channels, last_inp_channels, kernel_size=3, padding=1)
        self.ocr = OCR(last_inp_channels, last_inp_channels//2, ocr_activation)
    ...
    def forward(self, x):
        ...
        x_region = self.conv_region(x)
        x = self.ocr(x_context, x_region)
