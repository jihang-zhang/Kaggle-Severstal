...
class SCSEModule(nn.Module):
    ...
    def __init__(self, channels, reduction=16, mode='maxout'):
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None,
        ...
        self.scse = SCSEModule(outplanes, planes // 4) if use_scse else None
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None,
                 cardinality=1, base_width=64, use_se=False, use_scse=False,
                 reduce_first=1, dilation=1, previous_dilation=1, norm_layer=nn.BatchNorm2d):
...
class ResNet(nn.Module):
    ...
    """
    def __init__(self, block, layers, num_classes=1000, in_chans=3, use_se=False, use_scse=False,
        ...
        largs = dict(use_se=use_se, use_scse=use_scse, reduce_first=block_reduce_first, norm_layer=norm_layer,
...
@register_model
def scse_resnext50d_32x4d(pretrained=False, num_classes=1000, in_chans=3, **kwargs):
    """Constructs a ResNeXt50d-32x4d model. ResNext50 w/ deep stem & avg pool downsample
    """
    default_cfg = default_cfgs['resnext50d_32x4d']
    model = ResNet(
